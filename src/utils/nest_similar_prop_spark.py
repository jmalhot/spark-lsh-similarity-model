...
def alterschema(df):
    ...
    for i in df.columns:
        ...
        if (
            (
                df.schema[i].dataType == df.schema['stories'].dataType) | (
                df.schema[i].dataType == df.schema['total_sqft'].dataType) | (
                df.schema[i].dataType == df.schema['basement'].dataType) | (
                    df.schema[i].dataType == df.schema['brokerage'].dataType) | (
