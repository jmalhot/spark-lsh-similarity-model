...
P_SCHEMA = StructType(
    (StructField(
        '_id', StringType(), True), StructField(
            'address_street', StringType(), True), StructField(
                'bathrooms', IntegerType(), True), StructField(
                    'beds', IntegerType(), True), StructField(
                        'city', StringType(), True), StructField(
                            'country', StringType(), True), StructField(
                                'created_at', TimestampType(), True), StructField(
                                    'external_type', StringType(), True), StructField(
                                        'has_basement', BooleanType(), True), StructField(
                                            'has_fireplace', BooleanType(), True), StructField(
                                                'has_garage', BooleanType(), True), StructField(
                                                    'has_pool', BooleanType(), True), StructField(
                                                        'images', ArrayType(
                                                            StructType(
                                                                (StructField(
                                                                    '_id', StringType(), True), StructField(
                                                                        'sha1', StringType(), True))), True), True), StructField(
                                                                            'parking_types', StringType(), True), StructField(
                                                                                'postal', StringType(), True), StructField(
                                                                                    'price_cents', IntegerType(), True), StructField(
                                                                                        'property_sub_type', StringType(), True), StructField(
                                                                                            'utilities', StringType(), True), StructField(
                                                                                                'province', StringType(), True), StructField(
                                                                                                    'year_built', IntegerType(), True), ))
